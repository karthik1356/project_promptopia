  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
        <Link href='/' className="flex gap-2 flex-center">
          <Image src='./assets/images/logo.svg' alt='proptialogo' width={30} height={30} className="object-contain"/>
        ...
        <Link href='/profile'>
        <Image src={session?.user.image} width={37} height={37} alt="profile" className="rounded-full"></Image>
        </Link>
              </div> : <>
              {
       ...
       <div className="sm:hidden flex relative">
            ...
            <Image src={session?.user?.image} width={37} height={37} alt="profile" onClick={()=>setToggleDropdown((prev)=>!prev)} className="rounded-full"></Image>
